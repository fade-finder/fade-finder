...
import {dataIngresos, optionsIngresos, dataServicios, optionsServicios} from '../utils/data'
...
const Negocio = () => {
	return (
		<>
          ...
          <h3 className='text-xl font-semibold text-center uppercase text-gray-800 mb-3'>Ingresos</h3>
          <h3 className='text-xl font-semibold text-center uppercase text-gray-800 mb-3'>Servicios completados</h3>
					<div>
